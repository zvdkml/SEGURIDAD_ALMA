<div class="wrap alma-security-wrap pr-4">
    ...
    <script>
    function createAlmaUser() {
        const username = document.getElementById('new-alma-user').value;
        const password = document.getElementById('new-alma-pass').value;
        const role = document.getElementById('new-alma-role').value;

        jQuery.post(alma_ajax.ajax_url, {
            action: 'alma_manage_users',
    ...
    function deleteAlmaUser(user_id) {
